...
const Welcome = () => {
  return (
    <div className="text-center rounded-lg bg-green-50 px-10">
      <div>
        <span className="text-3xl font-bold"> Where Nature Unveils its Bounty, and Every Harvest Tells a Story </span>
      </div>
